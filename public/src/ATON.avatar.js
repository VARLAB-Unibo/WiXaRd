...
// Loads custom avatar representation (3D model)
    ...
    update() {
        ...
        if (cam === undefined || eye === undefined) {
            return;
        }
        ...
        if (this.userlabelnode) {
            this.userlabelnode.orientToCamera();
        }
