/**
 ...
 Contains key maps for the BaseKeyboard component.
 Most languages need a specific keyboard. Therefore, BaseKeyboard takes a language attribute
    ...
    fr:
        [
            [
                ...
                [
                    {width: 0.2, command: 'switch-set', chars: [{lowerCase: 'set'}]},
    ...
    ru:
        [
            [
                ...
                [
                    {width: 0.15, command: 'switch-set', chars: [{lowerCase: 'set'}]},
    ...
    nord:
        [
            [
                ...
                [
					{width: 0.2, command: 'switch-set', chars: [{lowerCase: 'eng'}]},
					{width: 0.2, command: 'switch', chars: [{lowerCase: '.?12'}]},
                    {width: 0.1, chars: [{lowerCase: ','}]},
                    {width: 0.4, command: 'space', chars: [{icon: 'space'}]},
                    {width: 0.1, chars: [{lowerCase: '.'}]},
