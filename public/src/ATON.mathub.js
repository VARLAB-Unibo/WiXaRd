...
MatHub.addDefaults = () => {
    ...
    MatHub.colors.lightgrey = new THREE.Color(0.220, 0.220, 0.220);
    ...
    // My Materials
    MatHub.addMaterial("fullyTransparent", new THREE.MeshBasicMaterial({
        transparent: true,
        depthWrite: false,
        opacity: 0.0
    }))

    MatHub.addMaterial("black", new THREE.MeshBasicMaterial({
    ...
    MatHub.addMaterial("red", new THREE.MeshBasicMaterial({
    ...
    // MatHub.addMaterial("black1", new THREE.MeshStandardMaterial({
    //     color: MatHub.colors.black,
    //     transparent: true,
    //     depthWrite: true,
    //     side: THREE.DoubleSide,
    ...
    */
    // MatHub.materials.black1 = new THREE.MeshStandardMaterial({
    //     color: MatHub.colors.black,
    //     transparent: true,
    //     depthWrite: true,
    //     side: THREE.DoubleSide,
    ...
    */
    ...
    MatHub.addMaterial("semanticShape", MatHub.materials.semanticShape = new THREE.ShaderMaterial({
    ...
    MatHub.addMaterial("semanticShapeHL", new THREE.MeshBasicMaterial({
    ...
    MatHub.addMaterial("semanticShapeEdit", new THREE.MeshBasicMaterial({
